...
import ImportView from "@/routes/Import";
      ...
      <aside className="w-56 shrink-0 bg-sidebar-bg border-r border-gray-200 p-3 flex flex-col">
        ...
        <div className="mt-auto pt-3 border-t border-gray-200">
          <button
            ...
            className="w-full px-3 py-1.5 text-sm rounded-md bg-gray-900 text-white text-left flex items-center justify-between hover:bg-gray-800"
          >
            Quick add
