...
import type { PayPeriodSchedule } from "@/api/types";
    ...
    <div className="p-6 space-y-8">
      ...
      <section>
        ...
        <p className="text-xs text-gray-600 mb-3 max-w-2xl">
          Category management moved to the <span className="font-medium">Budgets & Categories</span>{" "}
          tab — colors, names, budget basis, and allocations all live there now.
        </p>
      </section>
